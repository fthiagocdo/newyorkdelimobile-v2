  ...
  Widget build(BuildContext context) {
    ...
    void changeUserInfo() async {
      try {
        ...
        if(image != null){
          try {
            changeImageProfile(image!.path);
          } catch (e) {
            throw Exception("Error on Firebase trying to upload the image profile");
          }
        }
            ...
            child: Column(
              children:[
                ...
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    radius: 60.0,
                    backgroundImage: NetworkImage(widget.userData['firebaseInfo'].photoURL)
                  ),
                ),
              ],
            ),
