...
import 'package:new_york_delivery_app/app/views/Checkout%20Screen/checkout.screen.dart';
...
import 'package:new_york_delivery_app/app/views/Splash%20Screen/splash_screen.screen.dart';
...
@override
  ...
  List<ModularRoute> get routes => [
    ChildRoute('/SplashScreen', child: (_,args) => const SplashScreenStartApp()),
    ...
    ChildRoute('/Collect', child: (_,args) =>  AddCollectScreen(info: args.data,)),
    ChildRoute('/Delivery-table', child: (_,args) => DeliveryTableScreen(info: args.data)),
    ChildRoute('/Checkout', child: (_,args) => const CheckoutScreen()),
  ];
}